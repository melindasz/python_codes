...
def is_valid_word(wordlist, word):
    ...
    True
    >>> is_valid_word(['MAMA', 'XAR', 'BOB', 'LU'], 'TOY')
    False
    """
...
def make_str_from_column(board, column_index):
    ...
    'NS'
    >>> make_str_from_column([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B'], ['V', 'P', 'G', 'B']], 0)
    'AXV'
    """

    column = ''
    for row in board:
        column = column + row[column_index]
...
def board_contains_word(board, word):
    ...
    True
    >>> board_contains_word([['A', 'N', 'T', 'T'], ['X', 'S', 'O', 'B']], 'BT')
    False
